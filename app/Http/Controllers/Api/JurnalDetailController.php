...
class JurnalDetailController extends Controller
{
    public function generateJurnalPDF(Request $request){
        ...
        #view()->share('jurnal',$jurnalDetailList);
        #$pdf = PDF::loadView('jurnal_report', $jurnalDetailList);
        #view()->share('jurnal',$jurnalDetailList);
        //$pdf = PDF::loadview('jurnal_report', array('jurnal' => $jurnalDetailList))->save('pdf/specification.pdf');

        // download PDF file with download method
        $pdf = PDF::loadview('jurnal_report',['jurnal'=>$jurnalDetailList]);
        //return $pdf->stream();
    	return $pdf->download('laporan-pegawai-pdf');
        #return view('jurnal_report',['jurnal'=>$jurnalDetailList]);

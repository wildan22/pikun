            ...
            <tbody>
                @foreach($response['data'] as $key => $val)
                    ...
                    <tr class="table-active">
                        <td style="font-weight:bold">{{$response['text_a']}}</td>
                        <td style="font-weight:bold" class="text-right">{{number_format($response['total_aktiva'],2,',','.')}}</td>
                    </tr>
                    <tr class="table-active">
                        <td style="font-weight:bold">{{$response['text_b']}}</td>
                        <td style="font-weight:bold" class="text-right">{{number_format($response['total_utang_modal'],2,',','.')}}</td>
                    </tr>
                @endforeach
